 ...
 * Modify the Rational class so that it correctly implements the comparable interface 
 * 
 */
public class Rational implements Comparable<Rational>
{
    ...
    @Override
    /***** ASSIGNMENT INSTRUCTION
    * i.e. each object should be able to compare itself to another object of the 
    * same type.   (3 marks)
    */
