...
public class UDPFileReceiver
{
    ...
    private final int incomingPacketOverhead = 87;
    ...
    {
        buffer = new byte[512 + incomingPacketOverhead];  //599 is the size of my message object. 512 payload, 87 overhead
        ...
        while (bytesReceived < bytesToReceive)
        {
            ...
            //write received sengment payload to file
            fileWriter.write(receiveMSG.getPacket(), 0, receiveMSG.getPacket().length);
